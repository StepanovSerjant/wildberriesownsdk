...
class OrdersStatusesAPIAction(WBAPIAction):
    ...
    def __init__(self, api_connector, body: Dict[str, Any], page: int = 1) -> None:
...
class GetSupplyAPIAction(WBAPIAction):
    ...
    def __init__(self, api_connector, supply_id: str, page: int = 1) -> None:
        super().__init__(api_connector, page=page)
...
class CreateSupplyAPIAction(WBAPIAction):
    ...
    def __init__(self, api_connector, name: str, page: int = 1) -> None:
        super().__init__(api_connector, page=page)
...
class OrdersToSupplyAPIAction(WBAPIAction):
    ...
    def __init__(self, api_connector, supply_id: str, order_id: int, page: int = 1) -> None:
